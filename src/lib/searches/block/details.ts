...
export async function perform(
  ...
  try {
    ...
    z.console.error(`Error getting block changes: ${JSON.stringify(error)}`);
  ...
  operation: {
    ...
    sample: {
      ...
      header: {
        ...
        signature:
          "ed25519:58sdWd6kxzhQdCGvHzxqvdtDLJzqspe74f3gytnqdxDLHf4eesXi7B3nYq2YaosCHZJYmcR4HPHKSoFm3WE4MbxT",
